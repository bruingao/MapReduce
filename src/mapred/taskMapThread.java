 ...
 * report the process exit status to JobTracker.
 *
 * @author      Rui Zhang
 * @author      Jing Gao
...
public class taskMapThread implements Runnable{
    ...
    /** 
     * constructor of taskMapThread class
     * 
     * @since           1.0
     */
    ...
    /** 
     * thread run function, execute the command of mapper task,
     * and report the process result to JobTracker
     * 
     * @since           1.0
     */
    @Override
...
//                    String files[] = response.split("\n");
    ...
    /** 
     * if job fails caused by exceptions in this thread,
     * notify JobTracker
     *
     * @param jobTracker    the JobTracker to notify 
     * @since               1.0
     */
